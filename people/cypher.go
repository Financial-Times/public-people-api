	...
	query := &neoism.CypherQuery{
		Statement: `
                        ...
                        WITH    canonical,
                                ...
                                { id:m.uuid, types:labels(m), prefLabel:m.prefLabel, title:m.title, changeEvents:[{startedAt:m.inceptionDate}, {endedAt:m.terminationDate}] } as m ORDER BY m.terminationDateEpoch ASC, m.inceptionDateEpoch ASC, r, rr
						WITH 	m, o,canonical,
                        		{ id:r.uuid, types:labels(r), prefLabel:r.prefLabel, changeEvents:[{startedAt:rr.inceptionDate},{endedAt:rr.terminationDate}] } as r ORDER BY rr.terminationDateEpoch ASC, rr.inceptionDateEpoch ASC
